...
#include <jni.h>
#include "com_fanchen_update_jni_PatchUpdate.h"
...
int applypatch(int argc,char * argv[])
{
    ...
    if(((fd=open(argv[1],O_RDONLY,0))<0) ||
        ...
        (close(fd)==-1))  printf("err");
    if((new=malloc(newsize+1))==NULL)  printf("err");
...
JNIEXPORT jint JNICALL Java_com_fanchen_update_jni_PatchUpdate_update(JNIEnv *env,
